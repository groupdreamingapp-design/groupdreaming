...
const contractClauses = [
    ...
    },
    {
        ...
        content: "Mensualmente se realizan dos adjudicaciones: una por sorteo y otra por licitación. En la licitación, que se realiza como una subasta, la oferta mínima es de una (1) cuota pura y la máxima es la totalidad de las cuotas puras futuras pendientes de pago. Resultará ganador el suscriptor que haya realizado la oferta más alta al finalizar el período de la subasta. En caso de empate entre dos o más ofertas, se declarará ganador al suscriptor que posea el número de orden más bajo dentro del grupo."
    },
    {
