...
export const initialGroups: Group[] = [
    ...
    { id: "ID-20240801-1024", capital: 10000, plazo: 24, cuotaPromedio: calculateCuotaPromedio(10000, 24), membersCount: 28, totalMembers: 48, status: "Abierto", userIsMember: true, userIsAwarded: false },
