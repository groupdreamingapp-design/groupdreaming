...
export const initialGroups: Group[] = [
    ...
    { id: "ID-20240510-8888", capital: 20000, plazo: 60, cuotaPromedio: calculateCuotaPromedio(20000, 60), membersCount: 120, totalMembers: 120, status: "Subastado", monthsCompleted: 6, userIsMember: true, userIsAwarded: false, activationDate: '2025-05-28T12:00:00Z' },
...
export let auctions: Omit<Auction, 'precioBase'>[] = [
    ...
    { id: "auc-4", groupId: "ID-20240510-8888", orderNumber: 88, capital: 20000, plazo: 60, cuotasPagadas: 6, highestBid: 0, endDate: getFutureDate(48), numberOfBids: 0, isMine: true },
];
